...
namespace House.DATA_ACCESS.Migrations
{
    ...
    [Migration("20250508120609_update_DeviceTbl")]
    partial class update_DeviceTbl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("House.DATA_ACCESS.Entities.Archive", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HouseStateId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("HouseStateId");
            ...
            modelBuilder.Entity("House.DATA_ACCESS.Entities.User", b =>
                {
                    ...
                    b.Property<float>("GasNormal")
                        .HasColumnType("real");

                    b.Property<float>("HumidityNormal")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("TemperatureNormal")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("House.DATA_ACCESS.Entities.Archive", b =>
                {
                    b.HasOne("House.DATA_ACCESS.Entities.HouseState", "HouseState")
                        .WithMany()
                        .HasForeignKey("HouseStateId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("House.DATA_ACCESS.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
